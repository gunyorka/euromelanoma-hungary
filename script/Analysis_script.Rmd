...
```{r}
# Package names
packages <- c("magrittr", "dplyr", "reshape2", "fastmatch", "psych", "parallel", "MASS", "pheatmap", "gridExtra", "ggplot2", "Hmisc","readxl", "cutpointr","ggpubr","tidyr", "readxl", "kableExtra", "purrr", "viridis", "lubridate", "flextable", "webshot", "tibble", "car")
